...
MoveSprite_Circular_Shaft:
		...
		move.w	d1,y_pos(a0)
		rts
; End of function MoveSprite_Circular_Shaft

; =============== S U B R O U T I N E =======================================

MoveSprite_Circular_XanBie:
		move.b	$3C(a0),d0
		bsr.w	GetSineCosine
		move.w	$3A(a0),d2
		muls.w	d0,d2
		...
		move.w	d1,y_pos(a0)
		rts
; End of function MoveSprite_Circular_XanBie
...
MoveSprite_CircularSimpleRadius:
		move.b	$3C(a0),d0
		bsr.w	GetSineCosine
		moveq	#0,d4
		move.b	$40(a0),d4
		...
		move.w	d5,y_pos(a0)
		rts
; End of function MoveSprite_CircularSimpleRadius
...
AngleY_LookupIndex:
		dc.w loc_84E16-AngleY_LookupIndex
...
AngleX_LookupIndex:
		dc.w loc_84E58-AngleX_LookupIndex
