...
Load_Sprites_Index: offsetTable
		...
		offsetTableEntry.w Load_Sprites_Init2	; 4
		offsetTableEntry.w Load_Sprites_Main2	; 6
; ---------------------------------------------------------------------------

Load_Sprites_Main2:
		subq.b	#4,(Object_load_routine).w
		bra.w	Load_Sprites_Main
; ---------------------------------------------------------------------------
