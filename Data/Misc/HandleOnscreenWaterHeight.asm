...
DynamicWater_SCZ1:
		move.w	#$1E0,(Target_water_level).w
		rts
...
loc_78F2:
		...
		ror.b	#2,d0
		lsr.w	#5,d0
		lea	StartingWaterHeights(pc),a1
		move.w	(a1,d0.w),d0
		move.w	d0,(Water_level).w
		move.w	d0,(Mean_water_level).w
		move.w	d0,(Target_water_level).w
...
WaterPalette_Index:
		dc.b 0, 0, 0, 0		; FDZ 1,2,3,4
		dc.b palid_SCZWater, palid_SCZWater, palid_SCZWater, palid_SCZWater		; SCZ 1,2,3,4
		dc.b 0, 0, 0, 0		; MGZ 1,2,3,4
		dc.b 0, 0, 0, 0		; DDZ 1,2,3,4
