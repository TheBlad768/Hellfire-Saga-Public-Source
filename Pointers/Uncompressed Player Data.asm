...
ArtUnc_InstaShield:		binclude "Objects/Shields/Uncompressed Art/Insta-Shield.bin"
	even
ArtUnc_BigInstaShield:		binclude "Objects/Shields/Uncompressed Art/Big Insta-Shield.bin"
	even
...
ArtUnc_BubbleShield:		binclude "Objects/Shields/Uncompressed Art/Bubble Shield.bin"
	even
ArtUnc_BlueShield:		binclude "Objects/Shields/Uncompressed Art/Blue Shield.bin"
	even