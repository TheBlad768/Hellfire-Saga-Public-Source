	...
	class SwingingPlatform : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Objects/Swinging Platform/KosinskiM Art/GHZ Swinging Platform.bin", CompressionType.KosinskiM), "../Objects/Swinging Platform/Object Data/Map - Swinging Platforms.asm", labels[i], 0));
		}
