...
CreateBossExpRoutineSet:
		...
		dc.l Obj_WaitForParent		; $20
		dc.l Obj_BossExpControl2

		dc.l Obj_WaitForParent		; $28
		dc.l Obj_NormalExpControl

		dc.l Obj_WaitForParent		; $30
		dc.l Obj_BossExpControlOff

		dc.l Obj_WaitForParentSound	; $38
		dc.l Obj_BossExpControl3
CreateBossExpParameterIndex: offsetTable
		...
		offsetTableEntry.w CreateBossExp_22
		offsetTableEntry.w CreateBossExp_24
...
CreateBossExp_22:	dc.b $80, $20, $20, $38
CreateBossExp_24:	dc.b	4, $30, $20, $10

; =============== S U B R O U T I N E =======================================

Obj_WaitForParentSound:
		move.b	(Level_frame_counter+1).w,d0
		andi.w	#7,d0
		bne.s	Obj_WaitForParent
		sfx	sfx_BreakBridge
...
Obj_BossExpControl3:
		...
		beq.s	loc_83EC2
		move.w	#2,$2E(a0)
		lea	(Child6_BossGrimReaper_Explosion).l,a2
		jsr	(CreateChild6_Simple).w
		bne.s	locret_83EC0
		bra.w	loc_83E90
; ---------------------------------------------------------------------------
