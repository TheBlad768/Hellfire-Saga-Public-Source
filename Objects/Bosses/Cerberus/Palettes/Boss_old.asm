...
BossCerberus_Init:
		...
		move.l	#BossCerberus_CheckSubroutine,d0
		cmpi.w	#1,(Difficulty_Flag).w
		bls.s		+
		move.l	#BossCerberus_Startup,d0
+		move.l	d0,$34(a0)
...
BossCerberus_CheckSubroutine:
		cmpi.w	#1,(Difficulty_Flag).w
		bls.s		BossCerberus_CheckSubroutine2
		jsr	(Random_Number).w
		andi.w	#%1100,d0
...
BossCerberus_Warning:
		...
		beq.s	BossCerberus_CheckTouch_Return
		subq.b	#1,obBCerb_Flash(a0)
		lea	(Pal_BossCerberus).l,a1
		btst	#0,obBCerb_Flash(a0)
		beq.s	+
		lea	$20(a1),a1
+		jmp	(PalLoad_Line1).w
; ---------------------------------------------------------------------------
