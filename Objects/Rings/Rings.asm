...
CollectRing:
		...
		bge.s	GiveRing_Sound			; NOV: If so, branch
		addq.b	#1,(v_rings).w			; NOV: Increment HP

GiveRing_UpdateHUD:
		ori.b	#1,(f_ringcount).w	; NOV: Update HP in HUD
...
loc_1A6B6:
		...
		move.w	#make_art_tile(ArtTile_Ring,0,1),art_tile(a1)
		move.b	#$84,4(a1)
		move.w	#$180,8(a1)
		move.b	#$47,$28(a1)
		move.b	#8,7(a1)
